  ...
  public dynamic class Person {
    ...
    public function equals(object:Person):Boolean {
      return ((name == object.name)
          && (age == object.age)
          && (isMarried == object.isMarried)
          && (colleague == object.colleague));
    }
    ...
    public function get isMarried():Boolean { return _isMarried; }
    public function set isMarried(value:Boolean):void { _isMarried = value; }

    public function get friends():Array { return _friends; }
    public function set friends(friends:Array):void { _friends = friends; }

    public function get siblings():Array { return _siblings; }
    ...
    public function set writeObject(object:Object):void{ _aWriteOnlyObject = object; }
  }
}
