...
package org.springextensions.actionscript.core.task.xml {
	...
	public class TaskElementsPreprocessorTest extends TestCase {
		...
		public function TaskElementsPreprocessorTest(methodName:String = null) {
			super(methodName);
			init();
		}
