...
package org.springextensions.actionscript.core.event {
	...
	public class EventBusTest extends TestCase {
		...
		public function testRemoveEventListenerInHandler():void {
			EventBus.addEventListener("testType", removeTestTypeHandler);
			EventBus.addEventListener("testType",testListener);
			assertFalse(_eventReceived);
			EventBus.dispatch("testType");
			assertTrue(_eventReceived);
		...
		private function removeTestTypeHandler(event:Event):void {
			EventBus.removeEventListener("testType", removeTestTypeHandler);
		}
