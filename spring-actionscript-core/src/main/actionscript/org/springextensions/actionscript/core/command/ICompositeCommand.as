...
package org.springextensions.actionscript.core.command {
	 ...
	 */
	[Event(name="compositeCommandComplete", type="org.springextensions.actionscript.core.command.event.CompositeCommandEvent")]
	/**
	 ...
	 */
	[Event(name="compositeCommandError", type="org.springextensions.actionscript.core.command.event.CompositeCommandEvent")]
	/**
	 ...
	 */
	[Event(name="compositeCommandBeforeExecuteCommand", type="org.springextensions.actionscript.core.command.event.CompositeCommandEvent")]
	/**
	 ...
	 */
	[Event(name="compositeCommandAfterExecuteCommand", type="org.springextensions.actionscript.core.command.event.CompositeCommandEvent")]
	/**
