...
package org.springextensions.actionscript.core.task {
	 ...
	 */
	[Event(name="taskAborted", type="org.springextensions.actionscript.core.task.event.TaskEvent")]
	/**
	 * Dispatched when the task is completed.
	 * @eventType org.springextensions.actionscript.core.task.event.TaskEvent.TASK_COMPLETE
	 */
	[Event(name="taskComplete", type="org.springextensions.actionscript.core.task.event.TaskEvent")]
	/**
	 ...
	 */
	[Event(name="taskBeforeExecuteCommand", type="org.springextensions.actionscript.core.task.event.TaskEvent")]
	/**
	 ...
	 */
	[Event(name="taskAfterExecuteCommand", type="org.springextensions.actionscript.core.task.event.TaskEvent")]
	/**
