...
package org.springextensions.actionscript.core.event {
	...
	[Deprecated(message="The ListenerCollection is deprecated in favor of the EventBusCollectionLookup in as3commons-eventbus", replacement="org.as3commons.eventbus.impl.EventBusCollectionLookup", since="v1.2")]
	/**
	 *
	 * @author Roland Zwaga
	 */
