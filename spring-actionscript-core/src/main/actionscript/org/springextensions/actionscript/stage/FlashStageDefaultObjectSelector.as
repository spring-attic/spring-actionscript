...
package org.springextensions.actionscript.stage {
	...
	/**
	 * Default <code>IObjectResolver</code> used for flash stage wiring.
	 *
	 * <p>
	 * Deny all flash.* and _* (skins, etc) classes.
	 * </p>
	 *
	 * <p>
	 ...
	 */
	public class FlashStageDefaultObjectSelector implements IObjectSelector {
		 ...
		 */
		public function FlashStageDefaultObjectSelector() {
			super();
		}
		...
		public function approve(object:Object):Boolean {
			...
			if (className.search(FLASH_PREFIX) > -1 || className.indexOf(UNDERSCORE) > -1) {
				return false;
			}
