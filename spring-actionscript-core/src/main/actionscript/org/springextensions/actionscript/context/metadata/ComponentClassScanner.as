...
package org.springextensions.actionscript.context.metadata {
	...
	/**
	 * The <code>ComponentClassScanner</code> scans all classes in the application that have been annotated with
	...
	public class ComponentClassScanner extends AbstractClassScanner implements IApplicationContextAware, IOrdered {
		...
		private static const LOGGER:ILogger = getLogger(ComponentClassScanner);
