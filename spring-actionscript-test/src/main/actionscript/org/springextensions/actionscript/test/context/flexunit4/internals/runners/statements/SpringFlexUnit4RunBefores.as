...
/**
 * The <code>SpringFlexUnit4RunBefores</code> should be run beforel a test is run.
 * 
 * @author Andrew Lewisohn
 * @since 1.1
 */
public class SpringFlexUnit4RunBefores extends AbstractSpringFlexUnit4Statement {
	 ...
	 */
	public function SpringFlexUnit4RunBefores(testInstance:Object, testMethod:Method, testContextManager:TestContextManager) {
